...
export function CardRow({ card, onClick }: Props) {
	...
	return (
		<li>
			<button
				type="button"
				className="ls-card-row ls-flat flex w-full items-center gap-2 rounded px-2 py-1.5 text-left text-fg! focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
